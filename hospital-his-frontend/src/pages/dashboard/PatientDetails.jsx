                    ...
                    {patient.idDocument?.hasOptedIn && patient.idDocument?.imagePath && (
                        <div className="mt-4 p-3 bg-blue-50 border border-blue-100 rounded-xl">
                            <div className="flex items-center gap-2">
                                ...
                                {!isDoctor && (
                                    <a
                                        href={`${(import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace('/api/v1', '') : (import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace('/api/v1', '') : 'http://localhost:5001') + '')}/${patient.idDocument.imagePath}`}
                                        target="_blank"
                            ...
                            <div className="p-6 max-h-[70vh] overflow-y-auto">
                                ...
                                {selectedLabResult.reportPdf && (
                                    <div className="flex gap-2 mb-4">
                                        <a
                                            href={`${(import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace('/api/v1', '') : (import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace('/api/v1', '') : 'http://localhost:5001') + '')}/${selectedLabResult.reportPdf.replace(/\\\\/g, '/')}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
