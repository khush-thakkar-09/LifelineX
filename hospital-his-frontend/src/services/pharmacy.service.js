...
const API_URL = (import.meta.env.VITE_API_URL || 'http://localhost:5001/api/v1') + '/pharmacy';
const APPOINTMENT_URL = (import.meta.env.VITE_API_URL || 'http://localhost:5001/api/v1') + '/opd/appointments';
const PRESCRIPTION_URL = (import.meta.env.VITE_API_URL || 'http://localhost:5001/api/v1') + '/prescriptions';
